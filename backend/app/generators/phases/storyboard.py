...
- 「角色」字段表示画面中实际出现的视觉人物或视觉主体，不表示台词说话人；旁白解说内容写入「中文台词」和「英文台词」。
- 如果画面中出现具体历史人物、群体或核心视觉主体，「角色」字段必须写出这些名称，不要只写“旁白”。
- 只有纯地图、文献、建筑、时间线、抽象符号等没有人物或已定义视觉主体出镜的分镜，才允许「角色」字段写“旁白”。
- 分镜数量不超过{MAX_STORY_BOARD_NUMBER}个。
...
分镜1：
角色：历史人物A，历史人物B
画面：历史人物A和历史人物B以清晰可辨认的人物形象出现在相关历史场景中，画面克制、适合知识类短视频。
中文台词：“一句客观简洁的中文旁白。”
英文台词："A concise English narration."

分镜2：
角色：旁白
画面：没有具体人物出镜的地图、文献、建筑或时间线画面，用适合知识类短视频的方式呈现背景信息。
中文台词：“一句客观简洁的中文旁白。”
英文台词："A concise English narration."
"""
)
